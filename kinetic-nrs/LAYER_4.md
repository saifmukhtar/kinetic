...
## 1. The Hook (Taxonomy)
This crate (`kinetic-nrs`) belongs to **Layer 4: Infrastructure**. It is the Name Resolution System branch that bridges core `.kin` verification logic with external UDP/TCP DNS protocols.
...
Isolating the Name Resolution System into its own dedicated Layer 4 crate provides two massive benefits:
