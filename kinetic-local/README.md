...
- **State Persistence:** Atomically writes and reads the global action state using fast binary (`bincode`) serialization and temporary files to prevent corruption.
