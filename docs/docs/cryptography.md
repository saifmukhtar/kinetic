...
Alice wants `example.kin`. She does not announce this. Instead, she creates a cryptographic commitment.
...
This hash $C$ looks like complete gibberish to the network. It leaks zero information about the name "example".
