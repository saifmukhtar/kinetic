...
This crate (`kinetic-network`) is the **absolute Trunk of Layer 4**. It is the most complex infrastructural component in the workspace. 
...
It acts as the final aggregator before the Layer 5 Executables (`kinetic-daemon`, `kinetic-node`) consume the API.
