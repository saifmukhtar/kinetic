...
pub use kinetic_primitives::keypairs::SovereignSignature;
pub use kinetic_types::action::{Hash256, NetworkAction, SignedNetworkAction};
...
/// ```
pub fn verify_sovereign_signature(
    pubkey: &kinetic_primitives::keypairs::SovereignPubKey,
    msg: &[u8],
...
mod tests {
    ...
    fn test_pause_history_double_mapping_flaw() {
        ...
        state.pause_history.push((
            kinetic_kyn::types::StartKyn::from(1000),
            kinetic_kyn::types::EndKyn::from(1100),
        ));
    ...
    fn test_pause_history_renewal_in_the_middle() {
        ...
        state.pause_history.push((
            kinetic_kyn::types::StartKyn::from(3000),
            kinetic_kyn::types::EndKyn::from(3100),
        ));
