...
pub struct PreviousProof {
    ...
    pub identity_signature: kinetic_primitives::keypairs::IdentitySignature,
}
...
impl PreviousProof {
    ...
    pub fn bytes(&self, network_salt: &[u8; 32]) -> Vec<u8> {
        ...
        bytes.extend_from_slice(self.identity_signature.as_bytes());
...
mod tests {
    ...
    fn test_previous_proof_serialization() {
        let prev = PreviousProof {
            ...
            identity_signature: kinetic_primitives::keypairs::IdentitySignature(vec![5, 6, 7]),
        };
