...
directories_to_scan = ['kinetic-cli', 'kinetic-wasm', 'kinetic-vdf', 'kinetic-storage', 'kinetic-keygen', 'kinetic-pac']
...
replacements = [
    ...
    (r'save_keypair_from_mnemonic\(([^,]+), ([^)]+)\)', r'save_keypair_from_mnemonic(\1, \2, kinetic_core::constants::NETWORK_ID)'),
]
