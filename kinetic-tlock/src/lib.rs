...
//! payloads to a future Drand Quicknet kyn, allowing for "Commit-and-Reveal"
...
/// publishes the randomness kyn for the specified `target_round`.
...
/// Decrypts a time-locked payload using the live Drand kyn signature.
pub fn decrypt_with_kyn(
    _ciphertext: &[u8],
    _kyn_signature: &[u8],
